...
const FOOTER_LINKS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Portfolio & Brand", href: "/solutions/portfolio-websites" },
      { label: "SaaS & MVP Build", href: "/solutions/saas-mvp" },
      { label: "Business Portals", href: "/solutions/business-platforms" },
      { label: "AI Automation", href: "/solutions/ai-automation" },
      { label: "Mobile Applications", href: "/solutions/mobile-apps" },
    ],
  },
  {
    title: "Services",
    links: [
      { label: "Full-Stack Web", href: "/services/web-dev" },
      { label: "Mobile Apps", href: "/services/mobile-dev" },
      { label: "AI & ML Workflows", href: "/services/ai-automation" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "joblesscodersbd@gmail.com", href: "mailto:joblesscodersbd@gmail.com" },
